...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\linewidth]{images/comparacion_modelos.png}
...
\textbf{ARREGLAR ESE ESPACIO EN EL MEDIO ENTRE LAS DOS FILAS}
...
\textbf{PONEMOS EN BENCHMARK? CREO QUE ESTA BUENO PERO YA ESTAMOS }


% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\linewidth]{images/comparacion_steps_0.png}
